...
from .views import index, ficha, nosotros, productos, usuarios, bodega
from .views import ventas, boleta, ingresar, misdatos, miscompras, carrito, ropa, poblar, mipassword, salir
